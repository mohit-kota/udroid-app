...
exec "$STAGE/frontend/weston" \
    ...
    --socket=wayland-gfxstream-clock-20260910 \
    --width=720 \
    --height=720 \
    --idle-time=0 \
    --log=/root/udroid-weston-socket-v1/weston-clock-20260910.log \
    -- \
    /usr/bin/env WAYLAND_DEBUG=client /usr/bin/weston-simple-shm
